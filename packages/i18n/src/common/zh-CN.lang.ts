...
export const localizationBundle = {
  ...
  contents: {
    ...
    'aiNative.inlineDiff.reveal': '在聊天中展示',
    'aiNative.inlineDiff.up': '上一处变更',
    'aiNative.inlineDiff.down': '下一处变更',
    'aiNative.inlineDiff.right': '下一处文件',
    'aiNative.inlineDiff.left': '上一处文件',
    'aiNative.inlineDiff.noMoreChangesUp': '顶部没有更多变更了',
    'aiNative.inlineDiff.noMoreChangesDown': '底部没有更多变更了',
    ...
    'preference.ai.native.llm.model.id': '模型 ID',
    ...
    'ai.native.mcp.url.placeHolder': '输入 SSE URL',
    ...
    'ai.native.mcp.url.isRequired': 'SSE URL 不能为空',
    ...
    'ai.native.mcp.config.title': 'MCP 配置',
