...
import { Disposable, Emitter, Event, IRange, ISelection, getDebugLogger } from '@Nuvio-MCP/ide-core-common';
...
import type { IDecorationApplyOptions, IResourceOpenOptions, ISingleEditOperation } from '@Nuvio-MCP/ide-editor';
