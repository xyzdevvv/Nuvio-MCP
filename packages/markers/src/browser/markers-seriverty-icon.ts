...
import { MarkerSeverity } from '@Nuvio-MCP/ide-core-browser';
import { Color, DARK, HIGH_CONTRAST_DARK, HIGH_CONTRAST_LIGHT, LIGHT, ThemeType } from '@Nuvio-MCP/ide-theme';
...
export { DARK, LIGHT, HIGH_CONTRAST_LIGHT, HIGH_CONTRAST_DARK, ThemeType } from '@Nuvio-MCP/ide-theme';
